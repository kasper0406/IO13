...
% TODO: Maaske lav flere maalinger der viser at 4MB er et godt valg for stoerre input.
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.9\textwidth]{m_d}
...
% TODO: Kommenter paa hvor mange elementer der skal tilfoejes for at det sker?

\subsection{BufferedStream}

For BufferedStream the memory efficient sifting algorithm was the highest performing. This is believed to be due to the same reasoning as explained in subsection~\ref{sec:sifting}.

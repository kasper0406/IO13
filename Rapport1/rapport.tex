...
expected when used in sorting.\todo{Lad os lige gaa over denne paragraf}
...
512B. If smaller amount should be written, it is\todo{Check this. Vi har mere data om dette nu. I buffered input xxxsmall}
...
of $k$ always seems to improve the performance\todo{Describe.}.
...
= 512MB$\todo{Why already at this point?}.

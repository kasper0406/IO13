...
interest for use in sorting\todo{Comment on ``curve'' for small buffers in plot. data ligger langt fra hinanden vs. den kan lave readahead + data begynder at ligge taet. Muligvis ogsaa ventetid for 32MB}.
...
measurements\todo{Maaske ikke designet til mange...}.
